...
closeFile
	...
	. . if parRight="" write !,%mindTrm("red"),"  Warning on line ",ix,": No port number specified..." quit
	. . if (parRight<%mindParams("min"))!(parRight>%mindParams("max")) write !,%mindTrm("red"),"  Warning on line ",ix,": Port number not valid..." quit
	...
	. . set found=0
	. . if parRight="" write !,%mindTrm("red"),"  Warning on line ",ix,": No log level specified..." quit
	. . set parRight=$zconvert(parRight,"L")
	. . set:$find(%mindParams("logLevels"),","_parRight_",") found=1
	. . if found=0 write !,%mindTrm("red"),"  Warning on line ",ix,": Invalid log level specified..." quit
	...
	. . if parRight="" write !,%mindTrm("red"),"  Warning on line ",ix,": No path specified..." quit
	. . if $$openFile^%mindLogger(parRight)=0 write !!,%mindTrm("red"),"WARNING: Log file could not be opened, defaulting to console.",!! quit
	...
	. . if parRight="" write !,%mindTrm("red"),"  Warning on line ",ix,": No path specified..." quit
	. . if $zsearch(parRight,-1)="" write !,%mindTrm("red"),"  Warning on line ",ix,": Path not found..." quit
	. . if $$isDir^%mindUtils(parRight)=0 write !,%mindTrm("red"),"  Warning on line ",ix,": Path is not a directory..." quit
	...
	. . if parRight'="YES",parRight'="NO" write !,%mindTrm("red"),"  Warning on line ",ix,": Only YES and NO supported..." quit
	...
	. . set parRight=$zconvert(parRight,"U")
	. . if parRight'="OFF",parRight'="GRAND",parRight'="DETAILS" write !,%mindTrm("red"),"  Warning on line ",ix,": Only OFF, GRAND and DETAILS supported..." quit
	...
	. . set parRight=$zconvert(parRight,"U")
	. . if parRight'="NONE",parRight'="BRIEF",parRight'="EXTENDED" write !,%mindTrm("red"),"  Warning on line ",ix,": Only NONE, BRIEF and EXTENDED supported..." quit
	...
	. . if parRight="" write !,%mindTrm("red"),"  Warning on line ",ix,": requires TCP or UDS..." quit
	. . set parRight=$zconvert(parRight,"U")
	. . if parRight'="TCP",parRight'="UDS" write !,%mindTrm("red"),"  Warning on line ",ix,": Only TCP and UDS supported..." quit
	...
	. . if parRight="" write !,%mindTrm("red"),"  Warning on line ",ix,": must provide a filename..." quit
	. . if $zlength(parRight)<3 write !,%mindTrm("red"),"  Warning on line ",ix,": Filename must be longer than 2 character..." quit
	...
	. . if parRight=""!(parRight<32)!(parRight>1024) write !,%mindTrm("red"),"  Warning on line ",ix,": console-width must be between 32 and 1024..." quit
	...
	. . if parRight=""!(parRight<0)!(parRight>2000) write !,%mindTrm("red"),"  Warning on line ",ix,": session-idle-timeout must be between 0 and 2000..." quit
	...
	;
	write %mindTrm("green"),!,"conf file processed..."
	;
